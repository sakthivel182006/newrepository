...
const Navbar = ({ sidebarOpen, setSidebarOpen }) => {
    ...
    const navLinks = [
        ...
        { path: "/insurancepolicy", name: "Policies", icon: <FiShield /> },
        { path: "/documentsupload", name: "Upload Docs", icon: <FiUpload /> },
        { path: "/trackstatus", name: "Track Status", icon: <FiSearch /> },
        { path: "/approvedclaims", name: "Approved Claims", icon: <FiCheckCircle /> },
